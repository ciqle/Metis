...
original_author="ciqle"
original_name="metis"
original_urlname="Metis"
original_description="Awesome metis created by ciqle" 
...
then
    ...
    echo "then run 'metis' or 'python -m metis'"
else
    poetry install
    echo "Applied Flask template"
    echo "Ensure you activate your env with 'poetry shell'"
    echo "then run 'metis' or 'python -m metis' or 'poetry run metis'"
fi
